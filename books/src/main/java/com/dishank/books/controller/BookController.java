package com.dishank.books.controller;

import com.dishank.books.entity.Book;
import com.dishank.books.exception.BookNotFoundException;
import com.dishank.books.request.BookRequest;
...
public class BookController {
    ...
    private void initializeBooks() {
        books.addAll(List.of(
                new Book(1, "Computer Science", "Ramesh", "Computer Science", 5),
                new Book(2, "Java Spring Master", "Suresh", "Computer Science", 5),
                new Book(3, "Why 1+1 Rocks", "Mahesh", "Math", 5),
                new Book(4, "How to Hibernate", "Kamplesh", "Science", 2),
                new Book(5, "A Pirate's Treasure", "Rupesh", "History", 3),
                new Book(6, "Why Better", "Bhupendra", "Math", 1)
        ));
    }
